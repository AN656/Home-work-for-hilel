...
export let page = {'num':0, 'text_content': ''};

// function load(number) {
// 	page.num = number;
// 	text_content = document.getElementById(`menu${number}`).textContent;
// }

	document.getElementById('menu1').addEventListener("click",function()
		{
		  page.num = 1;
			text_content = document.getElementById(`menu1`).textContent;
		});
	document.getElementById('menu2').addEventListener("click",function()
		{
		  page.num = 2;
			text_content = document.getElementById(`menu2`).textContent;
		});
	document.getElementById('menu3').addEventListener("click",function()
		{
		  page.num = 3;
			text_content = document.getElementById(`menu3`).textContent;
		});
	document.getElementById('menu4').addEventListener("click",function()
		{
		  page.num = 4;
			text_content = document.getElementById(`menu4`).textContent;
		});
	document.getElementById('menu5').addEventListener("click",function()
		{
		  page.num = 5;
			text_content = document.getElementById(`menu5`).textContent;
		});
	document.getElementById('menu6').addEventListener("click",function()
		{
		  page.num = 6;
			text_content = document.getElementById(`menu6`).textContent;
		});

//Функция показа разных заголовков 
export function pageShow(obj)
{
	document.getElementById('title1').textContent = obj.text_content;
	switch(obj.num)
	{
		case 4:
		case 6:
			document.getElementById('genn1').textContent = 'Тут буде рівняння';
			break;
		default:
			document.getElementById('genn1').textContent = 'Тут буде вираз';
			break;
	} 
}
...
//Функция клика
export function event(number)
{
	let gener = generator_list[number-1]();
	switch(number)
	{
		case 4:
		case 5:
		case 6:
			document.getElementById(`genn1`).textContent = `${gener[0]}`;
			document.getElementById(`answer1`).textContent = `${gener[1]}`;
			break;
		default:
			document.getElementById(`genn1`).textContent = `${gener}`;
			document.getElementById(`answer1`).textContent = `=${eval(gener)}`;
			break;
	}
}
...
{
	if(document.getElementById('answer1').hidden == true)
	{
		document.getElementById('answer1').hidden = false;
	}
	else document.getElementById('answer1').hidden = true;
}
